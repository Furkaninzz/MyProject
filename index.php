...
<body>
  <div class="p-4 fixed-top">
    <nav class="navbar navbar-expand-lg bg-body-tertiary rounded-4 shadow-lg px-5">
      ...
      <a class="navbar-brand" href="index.php"><img src="assets/favicon/black/favicon-32x32.png"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <label class="switch"><input class="switch__input" type="checkbox" role="switch"><svg class="switch__icon switch__icon--light" viewBox="0 0 12 12" width="12px" height="8px" aria-hidden="true"><g fill="none" stroke="#fff" stroke-width="1" stroke-linecap="round">
  ...
  <main class="mb-5 pb-5">
    ...
    <footer class="bg-light p-5">
      <p class="text-center">F App &copy; Tüm hakları saklıdır.</p>
    </footer>
