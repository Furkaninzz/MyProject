...
<body>
  <nav class="p-4 fixed-top">
    <div class="navbar-expand-lg rounded-4 shadow-lg px-5 bg-light navbar">
      <a class="navbar-brand" href="#"><img src="assets/favicon/black/favicon-32x32.png" alt="" srcset=""></a>
  ...
  <header class="px-5 py-4 mb-2">
    <nav class="navbar navbar-expand-lg bg-body-tertiary shadow-lg rounded">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php"><img src="" alt="" srcset=""></a>
